...
public class Common {
    ...
    public static final PoweredFurnaceBlock POWERED_FURNACE_BLOCK = new PoweredFurnaceBlock(AbstractBlock.Settings.of(Material.METAL).strength(3.5f,3.5f).sounds(BlockSoundGroup.ANVIL));
