...
public class Common {
    ...
    public static void appendOres(String id){
        Registryhelper.registerMaterialBlock(new Identifier(Main.MOD_ID, id + "_ore"), new Block(AbstractBlock.Settings.of(Material.METAL).strength(5.0f,6.0f)));
        ...
        Registryhelper.registerMaterialBlock(new Identifier(Main.MOD_ID, "raw_" + id + "_block"), new Block(AbstractBlock.Settings.of(Material.METAL).strength(5.0f,6.0f)));
        makeList(id);
    }
