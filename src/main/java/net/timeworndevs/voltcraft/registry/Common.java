...
public class Common {
    ...
    //ingot
    public static final Item COPPER_NUGGET = Registryhelper.makeItem("copper_nugget", new Item(new FabricItemSettings().group(ItemGroup.MATERIALS)));
    //raw
    ...
    /*lead*/
    public static final Block LEAD_BLOCK = Registryhelper.makeBlock("lead_block", new Block(AbstractBlock.Settings.of(Material.METAL).strength(5.0f,6.0f).sounds(BlockSoundGroup.METAL)), Groups.BLOCKS);
    public static final Block LEAD_ORE = Registryhelper.makeBlock("lead_ore", new Block(AbstractBlock.Settings.of(Material.STONE).strength(5.0f,6.0f).sounds(BlockSoundGroup.STONE)), Groups.BLOCKS);
    public static final Block DEEPSLATE_LEAD_ORE = Registryhelper.makeBlock("deepslate_lead_ore", new Block(AbstractBlock.Settings.of(Material.STONE).strength(5.0f,6.0f).sounds(BlockSoundGroup.DEEPSLATE)), Groups.BLOCKS);
    public static final Block RAW_LEAD_BLOCK = Registryhelper.makeBlock("raw_lead_block", new Block(AbstractBlock.Settings.of(Material.METAL).strength(5.0f,6.0f).sounds(BlockSoundGroup.STONE)), Groups.BLOCKS);
    ...
    public static final Item RAW_LEAD = Registryhelper.makeItem("raw_lead", new Item(new FabricItemSettings().group(Groups.MATERIALS)));
    public static final Item LEAD_PLATE = Registryhelper.makeItem("lead_plate", new Item(new FabricItemSettings().group(Groups.MATERIALS)));
    ...
    /*nickel*/
    public static final Block NICKEL_BLOCK = Registryhelper.makeBlock("nickel_block", new Block(AbstractBlock.Settings.of(Material.METAL).strength(5.0f,6.0f).sounds(BlockSoundGroup.METAL)), Groups.BLOCKS);
    public static final Block NICKEL_ORE = Registryhelper.makeBlock("nickel_ore", new Block(AbstractBlock.Settings.of(Material.STONE).strength(5.0f,6.0f).sounds(BlockSoundGroup.STONE)), Groups.BLOCKS);
    public static final Block DEEPSLATE_NICKEL_ORE = Registryhelper.makeBlock("deepslate_nickel_ore", new Block(AbstractBlock.Settings.of(Material.STONE).strength(5.0f,6.0f).sounds(BlockSoundGroup.DEEPSLATE)), Groups.BLOCKS);
    public static final Block RAW_NICKEL_BLOCK = Registryhelper.makeBlock("raw_nickel_block", new Block(AbstractBlock.Settings.of(Material.METAL).strength(5.0f,6.0f).sounds(BlockSoundGroup.STONE)), Groups.BLOCKS);
    ...
    public static final Item NICKEL_NUGGET = Registryhelper.makeItem("raw_nickel", new Item(new FabricItemSettings().group(Groups.MATERIALS)));
    public static final Item RAW_NICKEL = Registryhelper.makeItem("nickel_nugget", new Item(new FabricItemSettings().group(Groups.MATERIALS)));
    ...
    /*silver*/
    public static final Block SILVER_BLOCK = Registryhelper.makeBlock("silver_block", new Block(AbstractBlock.Settings.of(Material.METAL).strength(5.0f,6.0f).sounds(BlockSoundGroup.METAL)), Groups.BLOCKS);
    public static final Block SILVER_ORE = Registryhelper.makeBlock("silver_ore", new Block(AbstractBlock.Settings.of(Material.STONE).strength(5.0f,6.0f).sounds(BlockSoundGroup.STONE)), Groups.BLOCKS);
    public static final Block DEEPSLATE_SILVER_ORE = Registryhelper.makeBlock("deepslate_silver_ore", new Block(AbstractBlock.Settings.of(Material.STONE).strength(5.0f,6.0f).sounds(BlockSoundGroup.DEEPSLATE)), Groups.BLOCKS);
    public static final Block RAW_SILVER_BLOCK = Registryhelper.makeBlock("raw_silver_block", new Block(AbstractBlock.Settings.of(Material.METAL).strength(5.0f,6.0f).sounds(BlockSoundGroup.STONE)), Groups.BLOCKS);
    ...
    public static final Item RAW_SILVER = Registryhelper.makeItem("raw_silver", new Item(new FabricItemSettings().group(Groups.MATERIALS)));
    ...
    /*bronze*/
    public static final Block BRONZE_BLOCK = Registryhelper.makeBlock("bronze_block", new Block(AbstractBlock.Settings.of(Material.METAL).strength(5.0f,6.0f).sounds(BlockSoundGroup.METAL)), Groups.BLOCKS);
    ...
    /*invar*/
    public static final Block INVAR_BLOCK = Registryhelper.makeBlock("invar_block", new Block(AbstractBlock.Settings.of(Material.METAL).strength(5.0f,6.0f).sounds(BlockSoundGroup.METAL)), Groups.BLOCKS);
    ...
    /*steel*/
    public static final Block STEEL_BLOCK = Registryhelper.makeBlock("steel_block", new Block(AbstractBlock.Settings.of(Material.METAL).strength(5.0f,6.0f).sounds(BlockSoundGroup.METAL)), Groups.BLOCKS);
