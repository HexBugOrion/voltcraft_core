package net.timeworndevs.voltcraft.block;
...
public class PoweredFurnaceBlock extends BlockWithEntity implements BlockEntityProvider {
    ...
    public void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState newState, boolean moved) {
        if (state.getBlock() != newState.getBlock()){
            ...
            if (blockEntity instanceof PoweredFurnaceBlockEntity) {
                ItemScatterer.spawn(world,pos, (PoweredFurnaceBlockEntity)blockEntity);
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return checkType(type, BlockEntities.POWERED_FURNACE, PoweredFurnaceBlockEntity::tick);
    }
}
